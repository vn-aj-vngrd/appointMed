            ...
            <form method="post">
                ...
                <div class="input-field">
	             ...
	             <div class="input-field">
                    ...
                    <input  type="text" name="date" placeholder="Date" onfocus="(this.type='date')" required >
                </div>

                <div class="input-field">
                    <i class="fas fa-clock"></i>
                    <input type="text" name="start" placeholder="Start Time" onfocus="(this.type='time')" required >
                </div>   
                
                <div class="input-field">
                    <i class="fas fa-clock"></i>
                    <input type="text" name="end" placeholder="End Time" onfocus="(this.type='time')" required >
                </div>  
